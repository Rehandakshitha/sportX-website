        ...
        <div class="navbar">
            ...
            <nav>
                <ul id="menuItems">
                    ...
                    <li><a href="<?php echo SITEURL; ?>shop.php" <?php if ($current_page == 'shop.php') echo 'class="active"'; ?> >Product</a></li>
                    <li><a href="<?php echo SITEURL; ?>sport.php" <?php if ($current_page == 'sport.php') echo 'class="active"'; ?> >Sport</a></li>
            ...
            <a  style="margin-left: 8px;" href="#"><span class="material-icons-outlined cart-icon">local_mall</span></a>
